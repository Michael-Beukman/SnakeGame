...
var $author$project$Types$Screen = F4(
	function (width, height, tileWidth, tileHeight) {
		return {height: height, tileHeight: tileHeight, tileWidth: tileWidth, width: width};
	});
var $author$project$Types$Vec2 = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var $author$project$Values$mapheight = 50;
var $author$project$Values$mapwidth = 50;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $elm$core$Basics$round = _Basics_round;
var $author$project$Values$timebeforeupdate = 50;
var $author$project$Main$init = function (_v0) {
	var startTime = _v0.startTime;
	var winWidth = _v0.winWidth;
	var winHeight = _v0.winHeight;
	var whichwidth = (_Utils_cmp(winHeight, winWidth) < 0) ? $author$project$Values$mapheight : $author$project$Values$mapwidth;
	var minW = (_Utils_cmp(winHeight, winWidth) < 0) ? winHeight : winWidth;
	var tilewidth = minW / whichwidth;
	var sWidth = $elm$core$Basics$round(tilewidth * $author$project$Values$mapwidth);
	var tileheight = tilewidth;
	var sHeight = $elm$core$Basics$round(tileheight * $author$project$Values$mapheight);
	return _Utils_Tuple2(
		{
			apple: A2($author$project$Types$Vec2, ($author$project$Values$mapwidth / 2) | 0, ($author$project$Values$mapheight / 4) | 0),
			gameOver: false,
			screen: A4($author$project$Types$Screen, sWidth, sHeight, tilewidth, tileheight),
			snakes: _List_fromArray(
				[
					{
					isDead: false,
					isGrowing: 0,
					points: _List_fromArray(
						[
							A2($author$project$Types$Vec2, 4, 0),
							A2($author$project$Types$Vec2, 3, 0),
							A2($author$project$Types$Vec2, 2, 0),
							A2($author$project$Types$Vec2, 1, 0),
							A2($author$project$Types$Vec2, 0, 0)
						]),
					velocity: A2($author$project$Types$Vec2, 1, 0)
				}
				]),
			timeToGo: $author$project$Values$timebeforeupdate
		},
...
var $author$project$Keys$toKey = function (keyValue) {
	var _v0 = A2(
		$elm$core$Maybe$withDefault,
		_Utils_Tuple2(
			_Utils_chr('d'),
			'b'),
		$elm$core$String$uncons(keyValue));
	var _char = _v0.a;
	var stuff = _v0.b;
	return (_Utils_eq(
		_char,
		_Utils_chr('w')) || (keyValue === 'ArrowUp')) ? $author$project$Types$Move($author$project$Types$Up) : ((_Utils_eq(
		_char,
		_Utils_chr('s')) || (keyValue === 'ArrowDown')) ? $author$project$Types$Move($author$project$Types$Down) : ((_Utils_eq(
		_char,
		_Utils_chr('a')) || (keyValue === 'ArrowLeft')) ? $author$project$Types$Move($author$project$Types$Left) : ((_Utils_eq(
		_char,
		_Utils_chr('d')) || (keyValue === 'ArrowRight')) ? $author$project$Types$Move($author$project$Types$Right) : ((keyValue === ' ') ? $author$project$Types$Move($author$project$Types$Space) : $author$project$Types$Move($author$project$Types$None)))));
};
var $author$project$Keys$keyDecoder = function () {
	var xxx = A2($elm$core$Debug$log, 'key 33 ', $elm$json$Json$Decode$string);
	return A2(
		$elm$json$Json$Decode$map,
		$author$project$Keys$toKey,
		A2($elm$json$Json$Decode$field, 'key', xxx));
}();
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$elm$browser$Browser$Events$onKeyDown($author$project$Keys$keyDecoder),
				$elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Types$Frame)
			]));
};
var $author$project$Types$NewApple = function (a) {
	return {$: 'NewApple', a: a};
};
var $author$project$Types$Snake = F4(
	function (points, velocity, isDead, isGrowing) {
		return {isDead: isDead, isGrowing: isGrowing, points: points, velocity: velocity};
	});
...
var $author$project$Types$mult = F2(
	function (num, vec) {
		return A2($author$project$Types$Vec2, vec.x * num, vec.y * num);
	});
...
var $author$project$Snake$changeSnakeVel = F2(
	function (snakes, dir) {
		var temp1 = $elm$core$List$head(snakes);
		var temp = $elm$core$List$tail(snakes);
		...
		var firstSnake = function () {
			if (temp1.$ === 'Nothing') {
				return A4(
					$author$project$Types$Snake,
					_List_Nil,
					A2($author$project$Types$Vec2, 1, 0),
					false,
					0);
		...
		var newvec = function () {
			switch (dir.$) {
				case 'Up':
					return A2($author$project$Types$Vec2, 0, -1);
				case 'Right':
					return A2($author$project$Types$Vec2, 1, 0);
				case 'Left':
					return A2($author$project$Types$Vec2, -1, 0);
				case 'Down':
					return A2($author$project$Types$Vec2, 0, 1);
				case 'None':
					return A2($author$project$Types$Vec2, 0, 0);
				default:
					return A2($author$project$Types$Vec2, 0, 0);
			}
		}();
		return _Utils_eq(
			newvec,
			A2($author$project$Types$mult, -1, firstSnake.velocity)) ? snakes : _Utils_ap(
			_List_fromArray(
				[
					_Utils_update(
					firstSnake,
					{
						velocity: _Utils_eq(
							newvec,
							A2($author$project$Types$Vec2, 0, 0)) ? firstSnake.velocity : newvec
					})
				]),
			othersnakes);
	});
var $author$project$Utils$makeEmptySnake = {
	isDead: false,
	isGrowing: 0,
	points: _List_Nil,
	velocity: A2($author$project$Types$Vec2, 1, 0)
};
var $author$project$Utils$firstSnake = function (li) {
	var t = $elm$core$List$head(li);
	if (t.$ === 'Nothing') {
		return $author$project$Utils$makeEmptySnake;
	} else {
		var v = t.a;
		return v;
	}
...
var $author$project$Main$pointrandom = A2(
	$elm$random$Random$pair,
	A2($elm$random$Random$int, 0, $author$project$Values$mapwidth - 1),
	A2($elm$random$Random$int, 0, $author$project$Values$mapheight - 1));
...
var $author$project$Utils$first = function (li) {
	var t = $elm$core$List$head(li);
	if (t.$ === 'Nothing') {
		return A2($author$project$Types$Vec2, 0, 1);
	} else {
...
var $author$project$Snake$checkSnakeApple = F2(
	function (apple, snake) {
		return snake.isDead ? _Utils_Tuple2(snake, false) : (_Utils_eq(
			$author$project$Utils$first(snake.points),
			apple) ? _Utils_Tuple2(
			_Utils_update(
				snake,
				{isGrowing: snake.isGrowing + 5}),
			true) : _Utils_Tuple2(snake, false));
	});
...
var $author$project$Snake$updateApple = F2(
	function (snakes, apple) {
		return function (_v0) {
			var ss = _v0.a;
			var gotapple = _v0.b;
			return _Utils_Tuple2(
			...
			$elm$core$List$unzip(
				A2(
					$elm$core$List$map,
					$author$project$Snake$checkSnakeApple(apple),
					snakes)));
	});
var $author$project$Utils$last = function (li) {
	var t = $elm$core$List$tail(li);
	if (t.$ === 'Nothing') {
		return _List_Nil;
	} else {
		var tt = t.a;
...
var $author$project$Snake$outsidemap = function (point) {
	return (_Utils_cmp(point.x, $author$project$Values$mapwidth) > -1) || ((point.x < 0) || ((_Utils_cmp(point.y, $author$project$Values$mapheight) > -1) || (point.y < 0)));
};
var $author$project$Snake$checkCollision = F2(
	function (snakes, snake) {
		var allpoints = A3(
			$elm$core$List$foldl,
			F2(
				function (snakeinside, currval) {
					return _Utils_eq(snake, snakeinside) ? currval : _Utils_ap(snakeinside.points, currval);
				}),
			_List_Nil,
			snakes);
		return snake.isDead ? snake : _Utils_update(
			snake,
			{
				isDead: A2(
					$elm$core$List$any,
					...
					_Utils_ap(
						allpoints,
						$author$project$Utils$last(snake.points))) || $author$project$Snake$outsidemap(
					$author$project$Utils$first(snake.points))
			});
	});
var $author$project$Types$vecstuff = F3(
	function (op, v1, v2) {
		return A2(
			$author$project$Types$Vec2,
			A2(op, v1.x, v2.x),
			A2(op, v1.y, v2.y));
	});
var $author$project$Types$add = $author$project$Types$vecstuff($elm$core$Basics$add);
...
var $author$project$Snake$updateSnake = function (snake) {
	return _Utils_update(
		snake,
		{
			isGrowing: (snake.isGrowing > 0) ? (snake.isGrowing - 1) : 0,
			points: _Utils_ap(
				_List_fromArray(
					[
						A2(
						$author$project$Types$add,
						$author$project$Utils$first(snake.points),
						snake.velocity)
					]),
				_Utils_ap(
					A2(
						$elm$core$List$take,
						$elm$core$List$length(snake.points) - 1,
						snake.points),
					function () {
						if (snake.isGrowing > 0) {
							var _v0 = $elm$core$List$head(
								$elm$core$List$reverse(snake.points));
							if (_v0.$ === 'Nothing') {
								return _List_Nil;
							} else {
								var li = _v0.a;
...
var $author$project$Snake$updateSnakes = function (snakes) {
	return A2(
		$elm$core$List$map,
		$author$project$Snake$checkCollision(snakes),
		A2($elm$core$List$map, $author$project$Snake$updateSnake, snakes));
};
var $author$project$Main$update = F2(
	function (msg, model) {
		return function (_v3) {
			...
			var cmd = _v3.b;
			return _Utils_Tuple2(
				$author$project$Utils$firstSnake(m.snakes).isDead ? _Utils_update(
					m,
					{gameOver: true}) : m,
				cmd);
		}(
			function (_v1) {
				...
				if (m.timeToGo < 0) {
					var _v2 = A2(
						$author$project$Snake$updateApple,
						$author$project$Snake$updateSnakes(m.snakes),
						model.apple);
					var newsnakes = _v2.a;
					var gotapple = _v2.b;
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{snakes: newsnakes, timeToGo: m.timeToGo + $author$project$Values$timebeforeupdate}),
						gotapple ? A2($elm$random$Random$generate, $author$project$Types$NewApple, $author$project$Main$pointrandom) : $elm$core$Platform$Cmd$none);
				} else {
					...
					switch (msg.$) {
						case 'Frame':
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{timeToGo: model.timeToGo - time}),
								$elm$core$Platform$Cmd$none);
						case 'Move':
							var dir = msg.a;
							return (_Utils_eq(dir, $author$project$Types$Space) && model.gameOver) ? $author$project$Main$init(
								{startTime: 1.0, winHeight: model.screen.height, winWidth: model.screen.width}) : _Utils_Tuple2(
								_Utils_update(
									model,
									{
										snakes: A2($author$project$Snake$changeSnakeVel, model.snakes, dir)
									}),
								$elm$core$Platform$Cmd$none);
						default:
							var newpoint = msg.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										apple: A2($author$project$Types$Vec2, newpoint.a, newpoint.b)
									}),
								$elm$core$Platform$Cmd$none);
					}
				}()));
...
var $author$project$Render$clearScreen = F2(
...
var $author$project$Render$renderApple = F3(
	function (apple, tileWidth, tileHeight) {
		return A2(
			$joakin$elm_canvas$Canvas$shapes,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_Utils_Tuple2((apple.x + 0.5) * tileWidth, (apple.y + 0.5) * tileHeight),
					tileWidth / 3)
				]));
	});
...
var $author$project$Render$renderRect = F3(
	function (tileWidth, tileHeight, vec) {
		return A2(
			$joakin$elm_canvas$Canvas$shapes,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A3(
					$joakin$elm_canvas$Canvas$rect,
					_Utils_Tuple2(vec.x * tileWidth, vec.y * tileHeight),
					tileWidth,
					tileHeight)
				]));
	});
var $author$project$Render$renderSnake = F3(
	function (tileW, tileH, snake) {
		return A2(
			$elm$core$List$map,
			A2($author$project$Render$renderRect, tileW, tileH),
			snake.points);
	});
var $author$project$Render$renderSnakes = F3(
	function (snakes, tileW, tileH) {
		return A3(
			$elm$core$List$foldl,
			...
			A2(
				$elm$core$List$map,
				A2($author$project$Render$renderSnake, tileW, tileH),
				snakes));
	});
var $author$project$Render$renderHorisontal = F3(
	function (screenheight, tileWidth, number) {
		return (!number) ? _List_Nil : _Utils_ap(
			_List_fromArray(
				[
					A2(
					$joakin$elm_canvas$Canvas$shapes,
					...
					_List_fromArray(
						[
							A3(
							$joakin$elm_canvas$Canvas$rect,
							_Utils_Tuple2((number - 1) * tileWidth, 0),
							tileWidth,
							screenheight)
						]))
				]),
			A3($author$project$Render$renderHorisontal, screenheight, tileWidth, number - 1));
	});
var $author$project$Render$renderVertical = F3(
	function (screenwidth, tileHeight, number) {
		return (!number) ? _List_Nil : _Utils_ap(
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							A3(
							$joakin$elm_canvas$Canvas$rect,
							_Utils_Tuple2(0, (number - 1) * tileHeight),
							screenwidth,
							tileHeight)
						]))
				]),
			A3($author$project$Render$renderVertical, screenwidth, tileHeight, number - 1));
	});
var $author$project$Render$renderSquares = F6(
	function (screenheight, screenwidth, width, height, tileWidth, tileHeight) {
		return _Utils_ap(
			A3($author$project$Render$renderHorisontal, screenheight, tileWidth, width),
			A3($author$project$Render$renderVertical, screenwidth, tileHeight, height));
	});
...
var $author$project$Render$renderMap = F8(
	function (tileW, tileH, screenwidth, screenheight, width, height, snakes, apple) {
		return A3(
			...
			_Utils_ap(
				_List_fromArray(
					[
						A2($author$project$Render$clearScreen, screenwidth, screenheight)
					]),
				_Utils_ap(
					A6($author$project$Render$renderSquares, screenheight, screenwidth, width, height, tileW, tileH),
					_Utils_ap(
						A3($author$project$Render$renderSnakes, snakes, tileW, tileH),
						_List_fromArray(
							[
								A3($author$project$Render$renderApple, apple, tileW, tileH)
							])))));
	});
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_Utils_ap(
			_List_Nil,
			function () {
				var firstS = $author$project$Utils$firstSnake(model.snakes);
				return model.gameOver ? _List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('game over. Space to restart')
							]))
					]) : _List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								'score: ' + $elm$core$String$fromInt(
									$elm$core$List$length(firstS.points)))
							])),
						A8(
						$author$project$Render$renderMap,
						model.screen.tileWidth,
						model.screen.tileHeight,
						model.screen.width,
						model.screen.height,
						$author$project$Values$mapwidth,
						$author$project$Values$mapheight,
						A2(
					...
					return A2(
						...
						function (startTime) {
							return $elm$json$Json$Decode$succeed(
								{startTime: startTime, winHeight: winHeight, winWidth: winWidth});
						},
